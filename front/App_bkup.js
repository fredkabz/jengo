...
{
  return(
    <AccountStack.Navigator screenOptions={{headerStyle:{backgroundColor:'#BD3737'},headerTintColor:'#fff' }}>
      <AccountStack.Screen name='Account' component={UserScreen} options={{headerShown:false}} />
      <AccountStack.Screen name='Edit_profile' component={EditProfile} options={{title:'Edit Profile',headerStyle:{backgroundColor:'white'},headerTintColor:'#BD3737'}}/>
      ...
      <AccountStack.Screen name='Post' component={PostScreen}/>
      <AccountStack.Screen name='ImageBrowser' component={ImageBrowserScreen}/>
  ...
  return (
    <NavigationContainer>
      ...
      screenOptions={
        ...
        <Tab.Screen name='tab_Home' component={HomeStackScreen} options={{
             tabBarLabel:"Home",
             tabBarIcon: (tabInfo) => {
              return (
                <Ionicons
                  name="home"
                  size={20}
                  color={tabInfo.focused ? "#BD3737" : "#8e8e93"}
                />
              );
            }, headerShown:false
           }} />
        <Tab.Screen name='tab_Categories' component={CategoriesStackScreen} options={{
        ...
        <Tab.Screen name='tab_Account' component={AccountStackScreen} options={{
            tabBarLabel:"Account",
            tabBarIcon: (tabInfo) => {
              return (
                <Ionicons
        ...
        <Tab.Screen name='tab_Settings' component={SettingsStackScreen} options={{
