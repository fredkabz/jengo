...
function AddCompany({ navigation }) {
 ...
 /* const user_name = state.user_name;
  ...
  const [description_edit, setGender] = useState(gender);
  ...
  */
  const [avatarSource, setAvatar] = useState(null);
  const [isUploading, setIsUploading] = useState(false);
  const [email_edit, setEmail] = useState(null);
  const [full_name_edit, setFullName] = useState(null);
 
  const [location_edit, setLocation] = useState(null);
  const [phone_no_edit, setPhoneNo] = useState(null);
  const [avatar_edit, setAvatarEdit] = useState(null);
  const [description_edit, setDescription] = useState(null);
