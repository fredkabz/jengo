...
class HomeSreen extends Component {
  ...
  displayItems = ({ item }) => {
    return (
      <View style={{ flex: 1, margin: 10, padding: 2}}>
        <View
          style={{
            flex: 1,
        ...
        >
          ...
          >
            <Image
              ...
              source={{
                uri:
                  "https://app.merrytimesacademy.com/jengo/images/categories/" +
                  item.image,
              }}
            />
          </TouchableWithoutFeedback>
      ...
      >
        <View style={{ flex: 1, flexDirection: "row" }}>
          ...
          >
            ...
            <View>
              <Text style={{color:'#137BD6',fontWeight:'bold'}}>Ksh.{item.amount}</Text>
            </View>
          </View>
        </View>
    ...
    return (
      <View style={{ flex: 1, backgroundColor: "#BD3737" }}>
        ...
        >
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <View style={styles.searchSection}>
                ...
                >
                  <Text style={[styles.input, { width: "79%" }]}>
          ...
          <ScrollView style={{ flex: 1, backgroundColor:'#fff', bottom: 50 }}>
            <View
              style={{
                width: "100%",
                marginBottom: 4,
            ...
            <View style={{ height: 100, marginTop: 10}}>
              ...
              />
              <View
                style={{ height: 1, backgroundColor: "#ccc", margin: 5 }}
              ></View>
            </View>
            <View
              style={{
